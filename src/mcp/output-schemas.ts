...
const planIssueSchema = z.object({
  ...
  section: z
    .enum(['sources', 'compression', 'resize', 'metadata', 'naming', 'backgroundRemoval', 'export'])
    .optional(),
...
const limitsSchema = z.object({
  maxFiles: z.number(),
  maxTotalInputBytes: z.number(),
  maxMegapixelsPerFile: z.number(),
  maxConcurrentFiles: z.number(),
  hashSmallFileBytes: z.number(),
...
export const planOutputSchema = {
  ...
  effectiveSettings: looseObject.describe('Fully resolved preset the run would apply.'),
